    ...
    pub fn get_all_audio_bank_items(&self) -> Value {
        ...
        let defaults = vec![
            ...
            (
                ...
                "Poço Artesiano ou Cacimba - Dados Específicos",
                "Usado especificamente quando o cliente informa que a fonte de água é poço artesiano ou cacimba para perguntar a profundidade do poço, distância e se há aclive (subida) no terreno.",
                "Entendido! Para poço artesiano ou cacimba, precisamos saber qual é a profundidade do poço, a distância até a caixa d'água e se o terreno possui algum aclive ou subida. Você saberia me informar esses dados?",
                "/assets/poco_artesiano_puck.mp3",
            ),
            (
                "rio_acude_detalhes",
                "Captação em Rio, Açude, Represa ou Lagoa",
                "Usado especificamente quando a fonte de água é um rio, açude, represa, lagoa ou cisterna para perguntar a altura de subida do terreno, a distância e a vazão em litros por dia.",
                "Entendido! Para captação em rio, açude, represa ou lagoa, precisamos saber a altura de subida do terreno, a distância até a caixa d'água e quantos litros por dia você precisa. Você saberia me informar?",
                "/assets/rio_acude_puck.mp3",
            ),
            (
                "profundidade_distancia",
                "Profundidade do Poço e Distância (Geral)",
                "Usado como alternativa para perguntar profundidade do poço e distância até o reservatório.",
                "Excelente! E qual é a profundidade aproximada do poço (ou nível da água) e a distância até o reservatório ou caixa d'água?",
                "/assets/stage_2_puck.mp3",
            ),
            (
